...
return [
    ...
    */
    ...
    'models' => [
        ...
        'usage' => \Gopayee\CashierRegister\Models\Usage::class,
        ...
        */
        ...
        'models' => [
            ...
            'subscription' => [
                ...
                'stripe' => \Gopayee\CashierRegister\Models\Stripe\Subscription::class,

                'paddle' => \Gopayee\CashierRegister\Models\Paddle\Subscription::class,
