...
namespace Gopayee\CashierRegister;
...
class Saas
{
     ...
     * @return \Gopayee\CashierRegister\Plan
     */
     ...
     * @return \Gopayee\CashierRegister\Feature
     */
     ...
     * @param  string|int  $id
     * @param  int|float  $value
     * @return \Gopayee\CashierRegister\MeteredFeature
     */
     ...
     * @return \Gopayee\CashierRegister\Item
     */
     ...
     * @param  \Gopayee\CashierRegister\Feature  $feature
     ...
     *
     * @param  \Gopayee\CashierRegister\Plan|string|int|null  $plan
     * @return \Gopayee\CashierRegister\Plan|null
     */
     ...
     *
     * @param  \Gopayee\CashierRegister\Item|string|int  $item
     * @return \Gopayee\CashierRegister\Item|null
     */
