...
use Gopayee\CashierRegister\Models\Usage;
...
trait HasQuotas
{
     ...
     * @return \Gopayee\CashierRegister\Models\Usage|null
     */
    public function recordFeatureUsage($feature, $value = 1, bool $incremental = true, Closure $exceedHandler = null)
    {
        ...
        /** @var \Gopayee\CashierRegister\Models\Usage $usage */
     ...
     *
     * @param  \Gopayee\CashierRegister\Feature|string|int  $id
     * @param  int|float  $uses
     * @return null|\Gopayee\CashierRegister\Models\Usage
     */
    public function reduceFeatureUsage($feature, $uses = 1, bool $incremental = true)
    {
        /** @var \Gopayee\CashierRegister\Models\Usage|null $usage */
     ...
     *
     * @param  \Gopayee\CashierRegister\Feature|string|int  $feature
     * @param  \Gopayee\CashierRegister\Models\Usage  $usage
     * @param  \Gopayee\CashierRegister\Plan|string|int|null  $plan
     * @return int|float
     */
